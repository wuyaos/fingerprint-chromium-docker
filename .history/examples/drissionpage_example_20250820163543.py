...
def main():
    ...
    try:
        ...
        print("You can view the browser in real-time at: http://localhost:6081")
        
    except Exception as e:
        print(f"❌ Error: {e}")
        print("Make sure the Docker container is running on port 9222")
        print("Run: docker run -d --name fpc -p 9222:9222 -p 6081:6081 yourname/fingerprint-chromium-drission:latest")
